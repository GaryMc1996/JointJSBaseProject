...
var paper = new joint.dia.Paper({
    ...
    origin: { x: 100, y: 100 },
    gridSize: 1,
    drawGrid: { color: 'red', thickness: 2 },
    model: graph,
    linkPinning: false,
...
var employee = new erd.Entity({
    ...
    attrs: {
        text: {
            ...
            text: 'Employee',
            'letter-spacing': 0,
            style: { 'text-shadow': '10px 0 10px #333333' }
        },
        '.outer, .inner': {
            fill: '#31d0c6',
            stroke: 'none',
...
var wage = new erd.WeakEntity({
    ...
    attrs: {
        ...
        '.outer': {
            fill: 'none',
            stroke: '#31d0c6',
            points: '165,-10 165,70 -10,70 -10,-10',
            filter: { name: 'dropShadow',  args: { dx: 0.5, dy: 20, blur: 20, color: '#333333' }}
        }
    }
});
...
graph.addCells([employee, salesman, wage, paid, isa,isa2, number, employeeName, skills, amount, date, plate, car, uses]);
